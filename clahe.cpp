...
void processVideo(Mat &h_input, Mat &h_output){
    ...
    clahe = cuda::createCLAHE(20);
    clahe->apply(d_gray, d_resoult);
...
int main(int argc, char* argv[]){
    ...
    srcVideo.open("videos/originalClahe.mp4", codec, fps, Size(frame_width, frame_height)); 
    resoultVideo.open("videos/resoultClahe.mp4", codec, fps, Size(frame_width, frame_height), false); 
